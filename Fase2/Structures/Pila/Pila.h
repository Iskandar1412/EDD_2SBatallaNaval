...
class ListaPila{
    public:
        ...
        void insertar(int jugada, string nombre){//por si piden que  se ingrese una lista de igual nombre hacer que no deje
            if(this->inicio == NULL){
                NodoListaP* lista = new NodoListaP(to_string(jugada)+nombre);
                this->longitud++;
        ...
        void agregaraPila(string nombre, int jugada, int x, int y){
            if(this->inicio == NULL){
                return;
            }else{
                NodoListaP* temp = this->inicio;
                while(temp != NULL){
                    if(temp->nombre == to_string(jugada)+nombre){
                        temp->abajo->push(x, y);
                        break;
                    }
                    temp = temp->siguiente;
        ...
        int obtenerXactual(int jugada, string nombre){
            int valx;
            if(this->inicio == NULL){
                cout<<endl;
            }else{
                ...
                while(temp != NULL){
                    if(temp->nombre == to_string(jugada)+nombre){
                        if(temp->abajo->cima != NULL){
                            valx = temp->abajo->cima->x;
                            break;
                        }
                    }
                }
        ...
        int obtenerYactual(int jugada, string nombre){
            int valy;
            if(this->inicio == NULL){
                cout<<endl;
            }else{
